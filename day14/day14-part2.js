...
async function puzzle() {
    ...
    for (let i = 0; i < width*height; i++) {
        ...
        let sFactor= quadrant1Count * quadrant2Count * quadrant3Count * quadrant4Count
        if(lowestSafetyFactor===null){
            lowestSafetyFactor=sFactor
            bestIteration=i
        }else if(sFactor<lowestSafetyFactor){
            lowestSafetyFactor=sFactor
            bestIteration=i
        }

    }
    console.log(`lowest safety factor is ${lowestSafetyFactor} seconds equal ${bestIteration+1}`)
